...
async def _poll_one(device_id: str, ip: str, creds: tuple[str, str] | None = None):
    ...
    codes_list = [settings.camera_event_codes] + [
        v for v in (
            # ── ДАРААЛЛЫН ЗАРЧИМ: БАТЛАГДСАН нь эхэнд, ЭРГЭЛЗЭЭТЭЙ нь эцэст ──
            # 2026-08-14, `stream_dump.py --compare` (10.0.106.10, 30с тус бүр):
            #   [TrafficJunction,TrafficSnapPicture,TrafficControl] → 8,396б, 2 event
            #   бусад бүх хувилбар                                  →   518б, 0 event
            #
            # АНХААР — энэ хэмжилт ЭЦСИЙН БИШ: цонх тус бүрд машин орсон эсэхийг
            # хянаагүй тул «0 event» нь «код ажиллахгүй» гэдгийг БИШ, зүгээр
            # «тэр 30 секундэд машин ирээгүй» гэдгийг ч илэрхийлж болно.
            # Үүнийг [TrafficJunction] ГАНЦААРАА ч 0 event өгсөн нь харуулна —
            # тэр нь ажилладаг хослолын ДЭД ОЛОНЛОГ шүү дээ.
            # Детерминист хэмжилт: `stream_dump.py --compare` нь одоо хувилбар
            # бүрд «Test Capture»-ээр event БАТАЛГААТАЙ үүсгэдэг болсон.
            #
            # Дараалал нь ямар ч тохиолдолд ЗӨВ: production дээр ажиллаж байгаа
            # нь эхэнд (эрсдэлгүй), эргэлзээтэй нь эцэст. Камер танихгүй код
            # агуулсан захиалгыг 200-аар хүлээж аваад чимээгүй хоосон урсгал
            # өгвөл 3 минут event алдах тул эхэнд тавьж БОЛОХГҮЙ.
            "[TrafficJunction,TrafficSnapPicture,TrafficControl]",
            "[TrafficJunction]", "[TrafficSnapPicture]",
            # Бусад firmware-т байж болзошгүй (ЭНЭ флотод ажиллахгүй нь батлагдсан)
            "[TrafficJunction,TrafficSnapPicture,TrafficControl,TrafficTollGate,Traffic]",
            "[TrafficTollGate,Traffic]", "[Traffic]", "[TrafficTollGate]", "[All]")

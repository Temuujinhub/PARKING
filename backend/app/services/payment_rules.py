...
CATALOG: list[dict] = [
    {"group": A.EXITRULES_KEY, "key": "payment_hold_minutes", "unit": "min",
     "name": "Төлбөр төлөх үеийн үнийг барих хугацаа",
     "desc": "Гарах камерт анх уншигдахад бодсон үнийг энэ хугацаанд хадгална. "
             "Хугацаа дуусвал орсон цагаас хойших НИЙТ хугацаагаар бодно. "
             "Дахин уншилт хугацааг сунгахгүй. 0 = үнэ барихгүй. Анхдагч 3 минут.",
     "applies": "Төлбөр хүлээж эхэлсэн машин", "not_applied": "Тогтмол суурь хураамж"},
    ...
    {"group": A.EXITRULES_KEY, "key": "reopen_max_hours", "unit": "hour",
     ...
     "desc": "Гарах камерт уншигдсан ч идэвхтэй бүртгэл алга бол энэ хугацаанд "
             "хаагдсан бүртгэлээс ЯГ НЭГ нэр дэвшигч олдвол сэргээнэ. Урт цонх (48ц) өмнөх өдрийн зогсолтыг сэргээж хий "
             "дүн нэхдэг байсан тул 12ц.",
     "applies": "Гарах уншилт · «бүртгэлгүй гарах» болохоос өмнө",
     "not_applied": "Төлөгдсөн; гарах камерт уншигдаад хаагдсан; олон нэр дэвшигч; junk"},
    {"group": A.EXITRULES_KEY, "key": "reopen_skip_exit_read", "unit": "bool",
     "name": "Гарцад уншигдаад төлөлгүй хаагдсан бүртгэлийг сэргээхгүй",
     "desc": "Гарах камерт уншигдсан (машин үнэхээр гарсан) мөртөө төлөлгүй "
             "авто хаагдсан бүртгэлийг дараагийн ирэлтэд сэргээж, орсноос "
             "хойшхи бүх цагийг нэхэхгүй (Маршил 2026-09-13: 63 сешн, 2.6 сая₮). "
             "Унтраавал хуучин зан.",
     "applies": "Гарах уншилт · авто сэргээлт", "not_applied": "«Хуурамч гарц» (богино зогсолт)"},
    {"group": A.EXITRULES_KEY, "key": "paid_wait_fallback_minutes", "unit": "min",
     "name": "Төлсөн-хүлээж буй машины fallback (мин)",
     "desc": "Утаснаасаа урьдчилж төлсөн машиныг гарах камер уншаагүй/буруу "
             "уншвал: сүүлийн N минутад төлсөн, гарцад уншигдаагүй бүртгэл ЯГ "
             "НЭГ байвал түүнийг энэ машин гэж үзэж хаалт нээнэ. Зөвхөн аль "
             "хэдийн ТӨЛСӨН машин гарна. 0 = унтраах.",
     "applies": "Гарах уншилт · junk эсвэл ≤2 тэмдэгт зөрүүтэй дугаар · бүртгэл олдоогүй",
     "not_applied": "Огт өөр зөв дугаар; 2+ нэр дэвшигч"},
    {"group": A.EXITRULES_KEY, "key": "exit_reread_seconds", "unit": "sec",
     "name": "Гарсан машины давтан уншилт (сек)",
     "desc": "Гарцад уншигдсан бүртгэл хаагдсанаас (төлсөн/үнэгүй) хойш энэ "
             "хугацаанд ижил эсвэл OCR-ойролцоо дугаар гарах камерт дахин "
             "уншигдвал тэр машины ДАВТАН уншилт гэж үзнэ: «орох уншилтгүй» "
             "суурь хураамж үүсгэхгүй, өмнөх зогсолтыг «хуурамч гарц» гэж "
             "сэргээхгүй. Эрхтэй бол хаалтыг дахин нээнэ. 2 тэмдэгтийн зөрүүг "
             "зөвхөн эхний 60с-д тооцно. 0 = унтраах.",
     "applies": "Гарах уншилт · нээлттэй бүртгэл олдоогүй үед",
     "not_applied": "Нээлттэй бүртгэлтэй таарсан уншилт (ердийн урсгал)"},
    {"group": A.EXITRULES_KEY, "key": "invoice_quote_minutes", "unit": "min",
     "name": "Нэхэмжлэлийн үнэ барих (мин)",
     "desc": "QR/нэхэмжлэл үүссэнээс хойш энэ хугацаанд төлөгдвөл жолоочид "
             "үзүүлсэн дүнгээр төлбөрийг хаана — төлж байх зуур тарифын шатлал "
             "ахисан (ж 2,000→5,000) үлдэгдэл нэхэхгүй. Хэтэрсэн бол одоогийн "
             "дүнгээр (дутуу бол нэмж төлнө). 0 = унтраах.",
     "applies": "QPay/POS/данс/партнерын төлбөр баталгаажих үед",
     "not_applied": "Хугацаа хэтэрсэн нэхэмжлэл; аль хэдийн хаагдсан бүртгэл"},
    ...
    {"group": A.BARRIER_KEY, "key": "entry_burst_max_diff", "unit": "count",
     "name": "Цуврал уншилт — нэг машин гэх дугаарын зөрүү (тэмдэгт)",
     "desc": "Burst цонхонд ирсэн зөв дугаар өмнөхөөс энэ тооноос ИХ тэмдэгтээр "
             "зөрвөл хаалт онгорхой байхад ард нь орсон ӨӨР машин гэж үзэж шинэ "
             "бүртгэл нээнэ (Маршил 2026-09-13: 387 машин залгигдсан). 7 = ямагт "
             "нэгтгэнэ (хуучин зан), 0 = зөвхөн junk→зөв/OCR-ойролцоо.",
     "applies": "Орох уншилт · burst цонх · зөв форматтай дугаар",
     "not_applied": "Формат буруу (junk) уншилт — ямагт нэгтгэнэ"},
    ...
    {"group": A.AUTOCLOSE_KEY, "key": "enabled", "unit": "bool",
     ...
     "applies": "Минут тутмын цэвэрлэгээ", "not_applied": "—"},
    ...
    {"group": A.AUTOCLOSE_KEY, "key": "awaiting_hours", "unit": "hour",
     ...
     "desc": "Төлбөр хүлээж эхэлснээс N цагийн дараа жагсаалтаас гаргана. "
             "Дахин уншилт, зураг, тэмдэглэл энэ хугацааг сунгахгүй. Өр үүсгэх "
             "тохиргоо асаалттай бол хамгийн сүүлийн гарах уншилтын үлдэгдлээр өр үүсгэнэ. 0 = унтраах.",
...
MAX: dict[tuple[str, str], int] = {
    (A.EXITRULES_KEY, "payment_hold_minutes"): 60,
    ...
    (A.EXITRULES_KEY, "paid_wait_fallback_minutes"): 120,
    (A.EXITRULES_KEY, "exit_reread_seconds"): 900,
    (A.EXITRULES_KEY, "invoice_quote_minutes"): 60,
    (A.BARRIER_KEY, "entry_burst_max_diff"): 7,

...
DEFAULTS: dict[str, dict] = {
    ...
    EXITRULES_KEY: {
        ...
        "fake_exit_minutes": 2,
        # Гарах уншилтаар авто сэргээх дээд хугацаа (кодод REOPEN_MAX_HOURS).
        # 48 → 12 (2026-09-13): 48ц цонх 2 хоногийн өмнөх хаагдсан зогсолтыг
        # сэргээж 50,000₮ нэхдэг байв (Маршил 53 сешн, 2.6 сая₮ хий дүн).
        "reopen_max_hours": 12,
        # Гарах камерт уншигдаад (exit_device_id) төлөлгүй хаагдсан бүртгэлийг
        # авто сэргээхгүй — машин үнэхээр гарсан (2026-09-13 Маршил: сэргээлт
        # 2 хоногийн 50,000₮ нэхдэг байв). False = хуучин зан.
        "reopen_skip_exit_read": True,
        # «ТӨЛСӨН-ХҮЛЭЭЖ БУЙ» FALLBACK (2026-09-13): утаснаасаа урьдчилж төлсөн
        # машиныг гарах камер уншаагүй/буруу (junk, OCR зөрүү) уншвал — тэр
        # зогсоолд сүүлийн N минутад төлсөн, гарцад уншигдаагүй сешн ЯГ НЭГ
        # байвал түүнийг энэ машин гэж үзэж хаалт нээнэ. Зөвхөн аль хэдийн
        # ТӨЛСӨН машин гарна тул мөнгөний эрсдэлгүй. 14 хоногт «төлсөн ч
        # нээгдээгүй» 216-ийн 184 нь энэ шалтгаантай (Кэй Эйч 33%). 0 = унтраах.
        "paid_wait_fallback_minutes": 10,
        # ГАРСАН МАШИНЫ ДАВТАН УНШИЛТ (2026-09-23): гарцад уншигдсан сешн
        # хаагдсанаас (төлсөн/үнэгүй) хойш N секундын дотор ижил/OCR-ойролцоо
        # дугаар гарах камерт ДАХИН уншигдвал тэр машин (төлөөд хаалтны доор
        # хөдөлж буй, ухарсан) — шинэ «орох уншилтгүй» суурь хураамж үүсгэхгүй,
        # өмнөх богино зогсолтыг «хуурамч гарц» гэж СЭРГЭЭХГҮЙ. 14 хоногт 488
        # хий 2000₮ (ихэнх нь төлсний дараах давтан уншилт) + Хангарьд 2942УКН
        # 5,000₮. 300с = ensure_exit_barrier_if_cleared-ийн «5 мин дотор
        # хаагдсан» эрхтэй ижил. 0 = унтраах.
        "exit_reread_seconds": 300,
        # НЭХЭМЖЛЭЛИЙН ҮНЭ БАРИХ (2026-09-23): QR нэхэмжлэл үүссэнээс хойш N
        # минутын дотор төлөгдвөл жолоочид ҮЗҮҮЛСЭН дүнгээр төлбөрийг хаана.
        # 317df72 (09-19) callback ирсэн цагаар дахин боддог болсноор төлж
        # байх 17 секундын дотор тарифын шатлал ахихад (1,500→2,000,
        # 2,000→5,000) үлдэгдэл нэхэж хаалт нээгдэхгүй болсон — 4 хоногт 18
        # PAYMENT_PARTIAL (500₮×10, 3,000₮×7). Хэтэрсэн (хуучин хямд нэхэмжлэл
        # цаг өнгөрсний дараа төлөх) тохиолдолд одоогийн дүнгээр — 317df72-ийн
        # хамгаалалт хэвээр. 0 = унтраах.
        "invoice_quote_minutes": 10,
    ...
    BARRIER_KEY: {
        ...
        # Burst цонхонд ирсэн ЗӨВ дугаар өмнөхөөс хамгийн ихдээ хэдэн тэмдэгтээр
        # зөрвөл «нэг машин» (дугаар засах) гэж үзэх вэ. 2026-09-13 Маршил:
        # хаалт онгорхой байхад 3–5с тутам орсон ӨӨР машинуудыг нэгтгэж (14
        # хоногт 428-ийн 387) сешнгүй үлдээж байв. Хэмжилт: ≤2 зөрүү = 15 кейс
        # бүгд OCR хувилбар, ≥3 = 652 өөр машин. 7 = ямагт нэгтгэнэ (хуучин зан),
        # 0 = зөвхөн junk→зөв ба OCR-ойролцоо (1 зөрүү).
        "entry_burst_max_diff": 2,
...
PER_SITE: dict[str, set[str]] = {
    ...
    EXITRULES_KEY: {"payment_hold_minutes", "no_session_fee", "min_stay_seconds", "fake_exit_minutes",
                    ...
                    "paid_wait_fallback_minutes", "exit_reread_seconds",
                    "invoice_quote_minutes", "wallet_auto_deduct"},
    BARRIER_KEY: {"dedup_seconds", "entry_burst_seconds", "entry_burst_max_diff",
                  "reopen_cooldown_sec", "exit_dedup_reopen"},

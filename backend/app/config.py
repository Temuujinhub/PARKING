...
class Settings(BaseSettings):
    ...
    # «4132» шиг 4-цифр-үсэггүй уншилт нь жинхэнэ гарах дугаартай (4132УАР)
    # хэзээ ч тохирдоггүй тул удаан хүлээх шаардлагагүй — 2ц дараа өргүй үнэгүй
    # хаана (2026-08-02, NIC-ийн дутуу уншилтын phantom). 0 = унтраах.
    invalid_plate_close_hours: int = 2

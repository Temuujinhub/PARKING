...
class Settings(BaseSettings):
    ...
    # ── ANPR системийн (172.16.100.20) event урсгалыг сонсох гүүр ────────────
    # Тэр систем ЯГ ТЭР камеруудаас уншилт авдаг тул манай стрим үхсэн эсэхийн
    # ГЭРЧ болно. Горим: off | shadow (зөвхөн бүртгэнэ) | witness (үхсэнийг
    # нотолмогц камерыг дахин холбуулна) | inject (уншилтыг манай урсгалд оруулна).
    anpr_bridge_mode: str = "off"
    anpr_bridge_url: str = "http://172.16.100.20/api/events"
    anpr_bridge_reconnect_sec: float = 15.0    # тэдний өөрсдийнхтэй ижил
    # Тэдний timestamp нь камерын цаг (гулсдаг) тул тулгах цонх өргөн
    anpr_bridge_match_window_sec: float = 300.0
    ...
    # Failed callback verification retry interval; never scans arbitrary PENDING invoices.
    # 0 disables the callback recovery worker.
    qpay_recheck_sec: int = 60
    qpay_recheck_batch_size: int = 20
    qpay_recheck_spacing_sec: float = 0.5
    qpay_callback_max_attempts: int = 8
    ...
    # Камерын цагийн зөрүүний дохионы босго (сек) — RealUTC пассив хэмжилт
    # (services/clock_drift.py). 120с = нөхөлт/тулгалтад мэдэгдэхүйц гажилт эхлэх түвшин.
    clock_drift_warn_sec: float = 120.0

    # LPR — уншилтын итгэлцүүрийн доод босго (%).
    # 2026-08-29 хүртэл энэ шүүлтүүр ОГТ ажиллаагүй: бодит утга Object.Confidence-д
    # ирдэг байхад код олохгүй тул бүх уншилт «100» гэж бүртгэгдэж байв. Одоо
    # бодит утга уншигдана. Прод тархалт (8/21–26, 19,959 уншилт): ≤30% нь 2.6%
    # (бараг цэвэр хог — эвдэрсэн/хагас уншилт), 90-өөс доош нь 43.3% (БОДИТ
    # машинууд!). Тиймээс 90 босго тавибал уншилтын бараг тал нь татгалзана —
    # 30 бол зөвхөн илт хогийг хаях болгоомжтой эхлэл. History/Logs дээр одоо
    # % харагдах тул хэдэн долоо хоног хэмжсэний ДАРАА л босгыг өсгөнө.
    lpr_min_confidence: float = 30.0
    # Гарсны дараах давхар event хамгаалалт (секунд). 2026-09-01: 20→30 —
    # орох/гарах камерт 30с дотор дахин уншигдвал давтан уншилт гэж тооцож
    # session ДАХИН бүртгэхгүй, амжилттай нээгдсэн хаалтыг ДАХИН нээхгүй.
    lpr_dedup_seconds: int = 30
    ...
    # Логоос сэргээсэн уншилтад ХААЛТ НЭЭХ дээд хоцрогдол. Мөчлөгийн завсар
    # (сүүлийн амжилттай таталтаас хойш) үүнээс их бол уншилтыг БҮРТГЭНЭ, харин
    # хаалт НЭЭХГҮЙ — машин аль хэдийн яваад өгсөн байх магадлалтай бөгөөд
    # эзэнгүй онгорхой хаалт нь уншуулалгүй нэвтрэх нүх болно.
    # Бичлэгийн огноо серверийн цагаас ЭНЭ ХЭМЖЭЭНЭЭС их ИРЭЭДҮЙД байвал
    # бичлэгийн бодит насыг мэдэх аргагүй тул ХААЛТ НЭЭХГҮЙ (camera_sync
    # бүртгэнэ). Хоёр хилийн хооронд сонгосон:
    #   • NTP-гүй камерын мэдэгдэж буй drift ~32 мин (Рашбулаг) — ажилласаар
    #     байх ЁСТОЙ, эс бол сэргээлт бүхэлдээ унтарна
    #   • 2026-08-22-ны бодит эвдрэлд бичлэг +1ц59м ирээдүйд харагдсан
    #     (камер УБ локал цагаар = +8ц, бичлэг нь 6 цагийн өмнөх) — ЗААВАЛ
    #     барих ёстой
    # 1 цаг нь хоёуланг нь тодорхой зааглана.
    log_tail_clock_skew_max_sec: float = 3600.0
    log_tail_open_max_lag_sec: float = 90.0
    ...
    # ӨМНӨХ ӨРТЭЙ машинд screen_fee_text-ийн АРД нэмэгдэх 4 дэх мөр (lattice LED
    # 4 логик мөртэй). Өмнө нь өнөөдрийн төлбөр + өр НЭГ дүнгээр гардаг байсан тул
    # жолооч «би 1 цаг зогсоод яагаад 25000₮ вэ» гэж маргадаг байв (2026-09-14).
    # {debt} = төлөгдөөгүй нөхөн төлбөрийн нийлбэр (ижил түрээслэгчийн зогсоолуудынх
    # — QR/касс яг үүнийг нэхэмжилдэг). Хоосон бол өрийн мөр гарахгүй.
    screen_debt_text: str = "Ur {debt}T"

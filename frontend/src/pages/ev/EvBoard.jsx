...
export default function EvBoard() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-5">
      ...
      {/* Зарчмын тайлбар. Өмнө нь Тохиргоо → Холболт → «Цэнэглэгч» дор байсан ч
          тэнд бүртгэх боломжгүй байсан тул хэрэглэгчийг төөрөгдүүлдэг байв —
          цэнэглэгчийн БҮХ зүйл (бүртгэл, төлөв, команд, цэнэглэлт) энэ хуудсанд
          нэгтгэгдсэн (2026-08-27). */}
      <details className="bg-slate-900 rounded-2xl px-4 py-3 text-sm">
        <summary className="cursor-pointer font-medium">Хэрхэн ажилладаг вэ</summary>
        <div className="text-slate-400 text-xs mt-2 space-y-1.5 max-w-3xl">
          <p>
            Цэнэглэгч OCPP-ээр hub рүү өөрөө холбогдоно. Шинэ цэнэглэгч гарч ирмэгц
            дээр «Шинэ (бүртгэлгүй) цэнэглэгчид» хэсэгт харагдана — «Бүртгэх» дарж
            зогсоол, нэр, бууцны тоог өгнө. Гараар урьдчилж бүртгэх шаардлагагүй.
          </p>
          <p>
            Машин цэнэглэгчид залгагдсан хугацаанд зогсоолын төлбөрийн тоолуур
            <b className="text-slate-300"> түр зогсоно</b> — гарахад цэнэглэсэн минут
            нийт хугацаанаас хасагдаж бодогдоно (дамжин зогсоолын тоолуур зогсоох
            механизмтай ижил, өдрийн дээд хязгаартай).
          </p>
          <p>
            Цэнэглэлтийн төлбөр жолоочийн <b className="text-slate-300">данснаас</b>
            {' '}хасагдана (1 Wh = 1₮ жишиг; үнийг «Тарифын төлөвлөгөө»-гөөр тохируулна).
          </p>
        </div>
      </details>

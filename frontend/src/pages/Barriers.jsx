    ...
    <div className="space-y-5">
      ...
      <div className="card">
        ...
        <div className="text-xs text-slate-500 mb-2">
          ...
          тусдаа мөрөнд гарна. Ж: <span className="font-mono">6425УБД|2ц 05м|5000₮|Тавтай морил</span>
        </div>
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <input className="input flex-1 min-w-48" maxLength={128} placeholder="Ж: 6425УБД|2ц 05м|5000₮|Тавтай морил"

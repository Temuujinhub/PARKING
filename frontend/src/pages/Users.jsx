...
const MODULE_GROUPS = [
  ...
  ['Санхүү', [
    ['reports', 'Тайлан + Мөнгөн тооцоо'], ['discounts', 'Хөнгөлөлт + Тариф + Өр цэвэрлэх'],
    ['drivers', 'Бүртгэлтэй машин'], ['vat', 'Ибаримт'], ['payments', 'Төлбөрийн үйлдэл'],
...
const ROLE_DEFAULTS = {
  ADMIN: ['dashboard', 'cashier', 'check', 'history', 'discounts', 'settings', 'reports',
    'drivers', 'vat', 'barriers', 'blacklist', 'logs', 'devices', 'compensations', 'users',
    'health', 'free_exit', 'pay_transfer'],

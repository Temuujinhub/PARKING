                  ...
                  <tr key={d.id} className={d.status === 'deleted' ? 'opacity-50' : ''}>
                    <td className="td font-medium">
                      ...
                      {/* Автомат нээх унтраалттай ОРОХ камер — жагсаалтаас харагдахгүй
                          учир «хаалт нээгдэхгүй байна» гэдгийг оношлоход маш удаан
                          хугацаа иддэг байв. ГАРАХ камерт энэ чагт огт үйлчилдэггүй
                          (хаалт нь төлбөр/гэрээтийн эрхээр шийдэгддэг) тул тэнд
                          анхааруулбал худал дохио болно — Засах модалд ч харагддаггүй. */}
                      {d.device_type === 'camera' && d.lane_dir === 'entry'
                        && d.status !== 'deleted' && !d.auto_open && (

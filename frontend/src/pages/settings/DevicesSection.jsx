                ...
                {list.map((d) => (
                  <tr key={d.id} className={d.status === 'deleted' ? 'opacity-50' : ''}>
                    <td className="td font-medium">
                      ...
                      {/* Автомат нээх унтраалттай камер — жагсаалтаас харагдахгүй
                          учир «хаалт нээгдэхгүй байна» гэдгийг оношлоход маш удаан
                          хугацаа иддэг байв. Хаалт төхөөрөмж дээр энэ чагт хэрэггүй
                          (командыг камер өөрөө биелүүлдэг) тул зөвхөн камерт харуулна. */}
                      {d.device_type === 'camera' && d.status !== 'deleted' && !d.auto_open && (

...
талбараар нэмж дамжуулна — систем **давхар баримт үүсгэхгүй**, терминалынхыг бүртгэнэ
(Ибаримт хуудсанд суваг = TERMINAL). Дамжуулахгүй бол систем өөрөө (msgbill.mn) үүсгэнэ.
